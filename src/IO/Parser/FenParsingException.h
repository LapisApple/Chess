...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Some Problems Occurred while Parsing the given Fen. \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Data is Missing In The Given Fen. \nPlease add it or change to a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "This Error should only be thrown when an unexpected Situation occurred or the given Fen is explicitly trying to break the Fen Reader. If you believe the Fen is actually legal open an issue on gitlab or github.\n"
                                                                      "The Fen Reader tried to access out of bounds of the given, probably illegal, Fen. \nPlease add the missing data, or add some trailing whitespace / other character, or simply change to a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "An Illegal Character has been found in the Board part of the Fen \nPlease remove it or change to a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "An Illegal Amount of Pieces and Whitespace has been found on A Row  \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "An Illegal Amount of Rows has been found in the board part of the Fen  \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "An Illegal Amount of Pieces has been found in one or more of the Teams \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "An Illegal Amount of Kings has been found in one or more of the Teams \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Illegal Castling Rights have been found in the Fen \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Castling Rights are missing in the Fen \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "An Illegal En Passant Position has been found in the Fen \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "En Passant Data is missing in the Fen \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Full Turn Data is missing in the Fen \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Half Turn Data is missing in the Fen \nPlease Try a different Fen"; }
};
...
public:
    [[nodiscard]] const char* what() const noexcept override { return "Current Player Color is missing in the Fen \nPlease Try a different Fen"; }
};