 ...
 */
template<> constexpr inline SlimOptional<Move> SlimOptional<Move>::nullopt() noexcept {
 ...
 */
template<> constexpr inline bool SlimOptional<Move>::has_value() const noexcept {
