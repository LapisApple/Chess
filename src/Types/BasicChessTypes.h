 ...
 */
enum PieceType : uint8_t { NONE = 0, KING, QUEEN, KNIGHT, BISHOP, CASTLE, PAWN = 6 };
}  // namespace PieceType
...
struct Piece {
   ...
   */
  constexpr Piece() noexcept : team(Team::NONE), type(PieceType::NONE) {}
   ...
   */
  static constexpr Piece getEmpty() noexcept { return Piece(Team::NONE, PieceType::NONE); }
   ...
   */
  constexpr bool operator==(Piece other) const { return this->team == other.team && this->type == other.type; }
  /**
